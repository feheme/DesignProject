(function($) {
    ...
    //info alerts
    $('.info-alert-left-top').on('click', function() {
        $.notify({
            // options
    ...
    $('.info-alert-right-top').on('click', function() {
        $.notify({
            // options
            message: 'Congratulations! You\'ve succcessfully completed the task.' 
        },{
    ...
    $('.info-alert-right-bottom').on('click', function() {
        $.notify({
            // options
            message: 'Congratulations! You\'ve succcessfully completed the task.' 
        },{
    ...
    $('.info-alert-left-bottom').on('click', function() {
        $.notify({
            // options
            message: 'Congratulations! You\'ve succcessfully completed the task.' 
        },{
    ...
    $('.info-alert-center-top').on('click', function() {
        $.notify({
            // options
            message: 'Congratulations! You\'ve succcessfully completed the task.' 
        },{
    ...
    $('.info-alert-center-bottom').on('click', function() {
        $.notify({
            // options
            message: 'Congratulations! You\'ve succcessfully completed the task.' 
        },{
